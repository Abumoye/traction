...
const EVENT_AFFILIATE_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbxMQo0BeqiJpbPuEvt_76xIbZXDu-A5HK7Q193iuu4Ii9GCIP0MdKzzmCmubQ0SSAGC/exec";
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', function (e) {
        ...
        .then(function () {
            statusEl.textContent = "Thank you. Your affiliate application has been received — our team will be in touch shortly with your unique affiliate code.";
